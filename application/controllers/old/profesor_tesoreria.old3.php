...
class Profesor_tesoreria extends CI_Controller {
    ...
    $total_final = round($total_a_pagar,2) + round($total_a_pagar_extras,2) + round($contrato_profesor->N_PUNTOS*$valor_punto,2);
    ...
    $html .= ' 
                        <tr>
                            ...
                            <th class="liquidacion"> </th>
                            <th  class="importe_de_extra">$ '.round($contrato_profesor->N_PUNTOS*$valor_punto,2).'</th>
                        </tr>
                    '; 
