...
<?php   if(in_array('ROLE_TESORERIA',$this->session->userdata('roles')) || ( in_array('ROLE_COORDINADOR',$this->session->userdata('roles')) && $row_programa->C_IDENTIFICACION != 3)): ?>
...
<?php   elseif(in_array('ROLE_COORDINADOR',$this->session->userdata('roles'))): ?>
