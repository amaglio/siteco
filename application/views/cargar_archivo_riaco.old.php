...
<div id="page-wrapper" >
    ...
    <div id="page-inner" style="margin:0px; ">
        ...
        <form  name="profesores_form" id="profesores_form" method="POST"  enctype="multipart/form-data" enctype="multipart/form-data" action="<?=base_url()?>index.php/programa/procesa_archivo_riaco/" > <!-- action="<?php base_url()?>/tesoreria/index.php/profesor_tesoreria/buscar_profesor_cursos/" -->
