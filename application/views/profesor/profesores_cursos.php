...
$datos_profesor_adedudador['nombre'] = urlencode(utf8_encode($datos_profesor->D_NOMBRES));
$datos_profesor_adedudador['apellido'] = urlencode(utf8_encode($datos_profesor->D_APELLIDOS));
$datos_profesor_adedudador['id_persona'] = $datos_profesor->N_ID_PERSONA;



//var_dump($profesor_adedudador_enviar);
...
<style type="text/css">
    h1.semestre
    {
        ...
        border-bottom: 2px solid #a5cbde;
        border-top: 2px solid #a5cbde;
        margin: 30px 0px;
    }
...
<div id="page-wrapper" >
    ...
    <div id="page-inner" style="margin:0px; ">
        ...
        <div class="panel panel-info" >
            ...
            <div class="panel-heading" style="padding-bottom:10px"> <!--Datos profesor--> 

                    <table class="table table-striped" style="border:none; margin-bottom:0px; padding-bottom:5px">
                        <tr>
                        ...
                        <?php   if(in_array('ROLE_TESORERIA',$this->session->userdata('roles'))): ?>
                                ...
                                <?php   if( $deudas_profesores->num_rows() > 0 ) : ?>

                                    <?php   foreach ($deudas_profesores->result() as $row): ?>
                                        
                                        <tr style="color:red">
                                                       
                                            <td ><strong>&#8226; Deuda del profesor [ <?=utf8_encode($row->C_ANIO_LECTIVO)?> ]: </strong>  $<?=utf8_encode($row->IMPORTE_ADEUDADO)?>.  </td>
                                            <td colspan="2">

                                                <?php 
                                                    $datos_profesor_adedudador['importe'] = $row->IMPORTE_ADEUDADO;
                                                    $datos_profesor_adedudador['comentario'] = urlencode(utf8_encode($row->COMENTARIO));
                                                    $profesor_adedudador_enviar = json_encode($datos_profesor_adedudador);
                                                    $profesor_adedudador_enviar = str_replace("\"", "&", $profesor_adedudador_enviar);
                                                ?>
                                                
                                                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" style=' margin-bottom:5px; ' data-target="#editar_deuda"  data-whatever="<?=$profesor_adedudador_enviar?>"> Editar </button> &nbsp;
                                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" style=' margin-bottom:5px;  '  onclick="eliminar_deuda(<?=$datos_profesor->N_ID_PERSONA?>, <?=$row->C_ANIO_LECTIVO?> )" > Eliminar </button>
                                ...
                                <?php   else:   ?> <!-- Agregar Deuda -->

                                        <tr >
                                            <td colspan="3" style="margin-bottom:35px">
                                                    
                                                    <?php 
                                                        $profesor_adedudador_enviar = json_encode($datos_profesor_adedudador);
                                                        $profesor_adedudador_enviar = str_replace("\"", "&", $profesor_adedudador_enviar);
                                                    ?>
                                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" style=' margin-bottom:5px; float:left;' data-target="#agregar_deuda"  data-whatever="<?=$profesor_adedudador_enviar?>"> Agregar deuda </button>
            ...
            <div class="panel-body">
                ...
                <ul class="nav nav-pills"  style="margin-bottom:15px;"> <!--Menu PILLS--> 
                    ...
                    <?php   if(in_array('ROLE_TESORERIA',$this->session->userdata('roles'))): ?>
                            ...
                            <li class="">
                                <a href="#div_liquidacion" data-toggle="tab"><i class="fa fa-usd"> Liquidacion mensual </i> </a>
                            </li>
                    ...
                    <li style="float:right">
                     ...
                     <li style="float:right">
                        <?php   if(in_array('ROLE_TESORERIA',$this->session->userdata('roles'))): ?>
                            <a style="float:right" href="<?php echo base_url(); ?>index.php/profesor/exportar_cursos_xls/<?php  echo $id_profesor; ?>" class="btn btn-primary btn-sm"><i class="fa fa-file"></i> Exportar XLS</a>
                        <?php   endif;?>
                ...
                <div class="tab-content">
                                            ...
                                            <tr style=" background-color:#428BCA; color:#fff; vertical-align: text-top; border-top:1px solid #428BCA; border-bottom:1px solid #0B3B0B;  ">
                                                ...
                                                <th style="vertical-align: middle;">Rol</th>
                                                 ...
                                                 <?php  if(in_array('ROLE_TESORERIA',$this->session->userdata('roles'))): ?>
                                                    ...
                                                    <?php  if( utf8_encode($contrato_profesor->M_RELACION) == 'Autonomos' ): ?>

                                                        <th style="vertical-align: middle;">Pag</th>
                                                    ...
                                                    <tr class="odd gradeX <?=$clase?>">
                                                        ...
                                                        <?php  if(in_array('ROLE_TESORERIA',$this->session->userdata('roles'))): ?>
                                                                ...
                                                                <td style="text-align:center;"> 
                                                                    ...
                                                                    <?php   if( $vector_importe[0] != 0 ): // Check
                                                                            ...
                                                                            echo round($vector_importe[0],3)."si";   ?>  
                                                                            
                                                                            <?php //  if( date_parse(date('d-M-y'))['month'] <= date_parse($row->FECHA_INI)['month'] ):  ?>
                                                                ...
                                                                <td class="info" style="text-align:center;"> 
                                                                    ...
                                                                    <?php   //if( date_parse(date('d-M-y'))['month'] <= date_parse($row->FECHA_INI)['month'] ):  
                                                                           ...
                                                                           //echo "Mes: ".date_parse($row->FECHA_INI)['month']."<br>";
                                                                           // echo "Mes: ".date_parse(date('d-M-y'))['month']."<br>";
                                                                ...
                                                                <?php  if( utf8_encode($contrato_profesor->M_RELACION) == 'Autonomos' ): ?>
                                                                       ...
                                                                       <td style="text-align:center;">
                                                                            <?php  if(isset($row->F_PAGADO)): ?>

                                                                
                                                                                <div data-toggle="tooltip" data-placement="bottom" title=""   data-original-title="<?=$row->F_PAGADO?>">
                                                        ...
                                                        <td class="celda_comentario" style='width:60px; padding:5px; border-right:1px solid #9FC5CC;'>
                                                                ...
                                                                <?php   if(isset($comentarios)&& $comentarios != " ") : 
                                                                        ...
                                                                        $comentarios_formateados = str_replace("|","\n",$row->C_OBS);
                                                                        //echo  $comentarios_formateados;
                                                                        //$comentarios_formateados = $row->C_OBS;
                                                                        ?>
                                                                        
                                                                        <div data-toggle="tooltip" data-placement="left" title="<?=$comentarios_formateados?>" style='width:70px; margin-bottom:5px; text-align:left; '>

                                                                            <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#exampleModal" data-whatever="<?=$datos_enviar?>"> 
                                                                                
                                                                                <i  class="fa fa-comment fa-1x" >
                                                                ...
                                                                <?php  $datos_enviar = generar_json_profesor_factura( $id_profesor, $id_curso, $anio_lectivo, $id_horario, $fecha_factura, $rol, $row->C_FACTURA_PROF ); ?>
                                                                <?php   
                                                                    $titulo = "";
                                                                    ...
                                                                    if($row->C_FACTURA_PROF)
                                                                        $titulo .= $row->C_FACTURA_PROF;

                                                                ?>

                                                                <div data-toggle="tooltip" data-placement="left" title="<?=$titulo?>" style='width:70px; margin-bottom:5px; text-align:left; '>

                                                                    <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#ingresar_fecha_pago" data-whatever="<?=$datos_enviar?>"> 
                    ...
                    <div class="tab-pane fade" id="extras"> <!--Extras-->
                        ...
                        <?php  if( utf8_encode($contrato_profesor->M_RELACION) == 'Relación de dependencia' ): ?>
                                                            ...
                                                            <select class="form-control" name="concepto" id="concepto">
                                                                ...
                                                                <?php  
                                                                    foreach($conceptos_extras->result() as $row): ?>
                                                                        ...
                                                                        <option value="<?=$row->CPTO?>"><?=utf8_encode($row->CPTO_NOMBRE)?></option>
                                                ...
                                                <tr>
                                                     ...
                                                     <td>
                                                            <?php 
                                                                ...
                                                                $datos_extras_cargados['observaciones'] = rawurldecode(utf8_encode($row->C_OBSERVACIONES));
                        ...
                        <?php  elseif( utf8_encode($contrato_profesor->M_RELACION) == 'Autonomos' ): ?>

                            <form id="form_cargar_extra_autonomo" name="form_cargar_extra_autonomo" method="post" action="<?=base_url()?>index.php/profesor/procesa_cargar_extra_autonomo" >
                                ...
                                <div class="col-md-5 col-lg-5 ">
                                    <div class="panel panel-danger"  style="margin-top:10px;">
                                        ...
                                        <div class="panel-heading">
                                            <h6><strong>CARGAR EXTRAS PARA AUTONOMOS (<i class="fa fa-usd"> </i>)</strong></h6>
                                        </div>
                                        <div class="panel-body">
                            ...
                            <div class="col-md-7 col-lg-7 ">
                                <div class="panel panel-danger"  style="margin-top:10px;">
                                    ...
                                    <div class="panel-heading">
                                        <h6><strong>EXTRAS CARGADOS A AUTONOMOS</strong></h6>
                                    </div>
                                    <div class="panel-body">
                                        
                                        <?php   if($extras_profesor_autonomo->num_rows() > 0 ): ?>
                                                
                                                <table class="table table-striped">
                                                    
                                            <?php   foreach ($extras_profesor_autonomo->result() as $row) 
                                                { ?>
                                                    <tr>
                                                         <td><?=$row->FECHA?></td>
                                                         <td>$<?=$row->IMPORTE?></td>
                                                         <td>
                                                                <?php 
                                                                    ...
                                                                    $datos_extras_cargados['id_extra_autonomo'] = $row->ID_EXTRA_AUTONOMO;
                                                                    $datos_extras_cargados['liquidacion'] = $row->FECHA;
                                                                    $datos_extras_cargados['importe'] = $row->IMPORTE;
                                                                    $datos_extras_cargados['id_profesor'] = $row->ID_PERSONA;
                                                                    $datos_extras_cargados['observaciones'] =  rawurldecode(utf8_encode($row->COMENTARIO));
                                                                ...
                                                                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editarExtraModalAutonomo" data-whatever="<?=$datos_extras_enviar?>" > 
                                                                        Editar
                                                                </button>

                                                                <button type="button" style="margin-top:5px" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#eliminarExtraModalAutonomo" data-whatever="<?=$datos_extras_enviar ?>"> 
                                                                        Eliminar
                                                                </button>
                    ...
                    <?php   if(in_array('ROLE_TESORERIA',$this->session->userdata('roles'))): ?>
                        ...
                        <div class="tab-pane fade" id="div_liquidacion">

                        <?php 

                            // Primer semestre
                            if(count($cursos_semestrales_liquidacion) || count($cursos_ejecutivos_liquidacion)): ?>
                                <h1 class="semestre">PRIMER SEMESTRE</h1>
                                <table class="table table-striped" style="text-align:center">
                                    <thead>
                                        <thead>
                                            <tr>
                                                <th style="widht:150px">
                                                <th>Ene</th>
                                                <th>Feb</th>
                                                <th>Mar</th>
                                                <th>Abril</th>
                                    ...
                                    <tbody>
                                    <?php // Cursos semestrales

                                        if( count($cursos_semestrales_liquidacion) ):

                                            foreach ($cursos_semestrales_liquidacion as $row): ?>
                                                
                                                <tr>
                                                    <td style="text-align:left">
                                                        <?=utf8_encode($row['materia'])?>
                                                    </td>
                                                    <?php for( $i=1; $i <= count($row['meses_curso']) / 2 ; $i++ ): ?>

                                  
                                                                    <td>
                                                                        <?=round($row['meses_curso'][$i])?>
                                                                    </td>
                                        ...
                                        if( isset($cursos_ejecutivos_liquidacion) && count($cursos_ejecutivos_liquidacion) > 0 ):

                                            foreach ($cursos_ejecutivos_liquidacion as $row): ?>
                                                
                                                <tr>
                                                    <td style="text-align:left">
                                                        <?=utf8_encode($row['materia'])?>
                                                    </td>
                                                    <?php for( $i=1; $i <= count($row['array_clases_curso']) / 2; $i++ ): ?>
                                                    
                                                        <td>
                                                            <?=round($row['array_clases_curso'][$i])?>
                                                        </td>
                                        ...
                                        ?>
                                            ...
                                            <tr style="border-top:3px solid #5f5f5f; background-color: #d2d1d1;">
                                                ...
                                                ?>
                                                      <td>
                                                            <?=$basico['total_1_semestre']?>
                                                        </td>
                                            </tr>

                                            <tr style="background-color: #d2d1d1;">
                                                <th style="text-align:left">
                                                   Adicional verdadero
                                                </th>
                                                <?php
                                                ...
                                                ?>
                                                        <td>
                                                            <?=$adicional_verdadero['total_1_semestre']?>
                                                        </td>
                                             </tr>

                                             <tr style="background-color: #d2d1d1;">
                                                <th style="text-align:left">
                                                   Adicional compensatorio
                                                </th>
                                                <td colspan="6"></td>
                                                <td>
                                                        <?=$adicional_compensatorio['total_1_semestre']?>
                                                </td>
                                            ...
                                            <tr style="background-color: #d2d1d1;">
                                                ...
                                                ?>
                                                        <td>
                                                            <?=$max_adicional['total_1_semestre']?>
                                                        </td>
                                            </tr>
                                            ...
                                            <tr style="background-color: #d2d1d1;">
                                                ...
                                                ?>
                                                        <td>
                                                            <?=$adicional_reportado['total_1_semestre']?>
                                                        </td>
                                            </tr>
                                            ...
                                            <tr style="background-color: #d2d1d1;"> 
                                                ...
                                                <?php
                                                 ...
                                                 <?php  } ?>
                                                        <td>
                                                            <?=$pago_total['total_1_semestre']?>
                                                        </td>
                                            </tr>
 
 
                                            
                                            <tr style="border-top:3px solid #5f5f5f; background-color: #d2d1d1; background-color: #d2d1d1;">
                                                <th style="text-align:left">
                                                   Previsión calculo
                                                </th>
                                                <?php
                                            ...
                                            <tr style="background-color: #d2d1d1;">
                                             ...
                                             <tr style="background-color: #d2d1d1;">
                                                ...
                                                <?php
                                                 ...
                                                 <?php  } ?>
                                                        <td>
                                                            <?=$remuneracion_avg['total_1_semestre']?>
                                                        </td>
                                            </tr>
                                                ...
                                                <th style="text-align:left">
                                                  ...
                                                  <?php
                                                        ...
                                                        {   ?>
                                                            ...
                                                            <td>
                                                                <?=$adicional_promedio[$i]?>
                                                            </td>
                                                 
                                                 <?php  } ?>
                                                        <td>
                                                            <?=$adicional_promedio['total_1_semestre']?>
                                                        </td>
                                            </tr>

                                            <tr style="border-bottom:3px solid #5f5f5f; background-color: #d2d1d1; background-color: #d2d1d1;">

                                                <th style="text-align:left">
                                                   Prevision vacaciones
                                                </th>
                                                 ...
                                                 <?php
                                                        ...
                                                        {   ?>
                                                            ...
                                                            <td>
                                                                <?=$prevision_vacaciones[$i]?>
                                                            </td>
                                                 
                                                 <?php  } ?>
                                                        <td>
                                                            <?=$prevision_vacaciones['total_1_semestre']?>
                                                        </td>
                                            </tr> 
                                            <tr style="border-bottom:3px solid #5f5f5f; background-color: #d2d1d1; background-color: #d2d1d1;">
                                            ...
                                            <tr style="border-bottom:3px solid #5f5f5f; background-color: #d2d1d1; background-color: #d2d1d1;">
                                                ...
                                                <td colspan="5"></td>
                                                <td>
                                                    <?=$total_con_aguinaldo[0]?>
                                                </td>
                                                <td>
                                                    <?=$total_con_aguinaldo[1]?>
                                                </td>   
                                            </tr> 
                                ...
                                <table class="table table-striped" style="text-align:center" style="margin-top:50px; width:50%">
                                    <thead>
                                        <thead>
                                            <tr>
                                                <th></th>
                                    ...
                                    <tbody>
                                            <tr>
                                                <th style="text-align:left">Aguinaldo extra</th>
                                                 <?php
                                                        for($i=0; $i<= 1; $i++) 
                                                        {  ?>
                                                            <td>
                                            ...
                                            <tr>
                                                <th style="text-align:left">Aguinaldo básico</th>
                                                 <?php
                                                        for($i=0; $i<= 1; $i++) 
                                                        {  ?>
                                                            <td>
                                            ...
                                            <tr>
                                                <th style="text-align:left">Vacacion Extra</th>
                                                 <?php
                                                        for($i=0; $i<= 1; $i++) 
                                                        {  ?>
                                                            <td>
                                            ...
                                            <tr>
                                                <th style="text-align:left">Vacacion Básica</th>
                                                 <?php
                                                        for($i=0; $i<= 1; $i++) 
                                                        {  ?>
                                                            <td>
                                ...
                                <table class="table table-striped" style="text-align:center" style="margin-top:50px; width:50%">
                                    ...
                                    <tbody>
                                            <tr>
                                                <th style="text-align:left"> Check brutos</th>
                                                 <?php
                                                        for($i=0; $i<= 1; $i++) 
                                                        {  ?>
                                                            <td>
                                            ...
                                            <tr>
                                                <th style="text-align:left">  Check netos </th>
                                                 <?php
                                                        for($i=0; $i<= 1; $i++) 
                                                        {  ?>
                                                            <td>
                                ...
                                <div>
                                    <label>Deuda remanente:</label><?=$deuda_remantente?> <br>
                                    <label>Pre deuda:</label><?=$pre_deuda?>
                                </div>
                        ...
                        <?php 
                            ...
                            // Segundo semestre
                            if(count($cursos_semestrales_liquidacion) || count($cursos_ejecutivos_liquidacion)): ?>
                                <h1 class="semestre"> SEGUNDO SEMESTRE</h1>
                                <table class="table table-striped" style="text-align:center" class="semestre">
                                    <thead>
                                        <thead>
                                            <tr>
                                                <th style="widht:150px">
                                        ...
                                        if( count($cursos_semestrales_liquidacion) ):
                                            ...
                                            foreach ($cursos_semestrales_liquidacion as $row): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php for( $i=7; $i <= count($row['meses_curso']) ; $i++ ): ?>
                                        ...
                                        if( isset($cursos_ejecutivos_liquidacion) && count($cursos_ejecutivos_liquidacion) > 0 ):
                                            ...
                                            foreach ($cursos_ejecutivos_liquidacion as $row): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php for( $i=7; $i <= count($row['array_clases_curso']) ; $i++ ): ?>
...
<!-- _________________ MODAL PARA MOSTRAR INGRESAR FECHA PAGADO ______________________  -->

<div class="modal fade" id="ingresar_fecha_pago" tabindex="-1" role="dialog" aria-labelledby="ingresar_fecha_pagoLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header" style=" background-color: #428BCA; color:#fff;">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="ingresar_fecha_pagoLabel">Ingresar Infomacion Factura</h4>
        </div>

        
        <form id="form_factura" name="form_factura" method="post" action="<?=base_url()?>index.php/profesor/procesa_editar_fecha_factura" >
            ...
            <div class="modal-body">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="materia" class="control-label">Fecha Pagado (Mes/Dia/Año)</label>
                        </div>
                        <div class="form-group">
                            <input class="form-control"  id="fecha_factura" type="date" name="fecha_factura"   />
                        </div>
                        <div class="form-group">
                            <label for="materia" class="control-label">Numero Factura</label>
                        </div>
                        <div class="form-group">
                            <input type='text' class="form-control" id='numero_factura' name='numero_factura' value=""/>
                        </div>
                    </div>
            </div>
...
<!-- _________________ MODAL PARA MOSTRAR HISTORIAL COMENTARIOS ______________________  -->
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header" style=" background-color: #428BCA; color:#fff;">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="exampleModalLabel">Ingresar comentarios</h4>
        </div>
 ...
 <!-- _________________ MODAL PARA EDITAR EXTRA ______________________  -->
        ...
        <form id="form_editar_extra" name="form_editar_extra" method="post" action="<?=base_url()?>index.php/profesor/procesa_editar_extra_profesor" >
            ...
            <div class="modal-body">              
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="liquidacion" id="liquidacion" type="text" value="" readonly="readonly" /> 
                </div>
                <div class="form-group">
...
<!-- _________________ MODAL PARA ELIMINAR EXTRA ______________________  -->

<div class="modal fade" id="eliminarExtraModal" tabindex="-1" role="dialog" aria-labelledby="eliminarExtraModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form id="form_eliminar_extra" name="form_eliminar_extra" method="post" action="<?=base_url()?>index.php/profesor/procesa_eliminar_extra_profesor" >
...
<!-- _________________ MODAL PARA EDITAR EXTRA AUTONOMO______________________  -->

<div class="modal fade" id="editarExtraModalAutonomo" tabindex="-1" role="dialog" aria-labelledby="editarExtraModalAutonomo">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        
        <div class="modal-header" style=" background-color: #428BCA; color:#fff;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="exampleModalLabel">Editar Extra Autonomo</h4>
        </div>

        <form id="form_editar_extra_autonomo" name="form_editar_extra_autonomo" method="post" action="<?=base_url()?>index.php/profesor/procesa_editar_extra_autonomo" >
        
            <div class="modal-body">              
            
                <input class="form-control" name="n_id_profesor" id="n_id_profesor" value="" type="hidden" />
                <input class="form-control" name="id_extra_autonomo" id="id_extra_autonomo"   type="text" />
                ...
                <div class="form-group">
                    <label for="importe" class="control-label">Importe extra($)</label>
                    <input class="form-control" name="importe" id="importe" type="text"  value="" />
                </div>
                <div class="form-group">
                    <label>Comentarios</label>
...
<!-- _________________ MODAL PARA ELIMINAR EXTRA AUTONOMO______________________ -->

<div class="modal fade" id="eliminarExtraModalAutonomo" tabindex="-1" role="dialog" aria-labelledby="eliminarExtraModalAutonomo">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form id="form_eliminar_extra" name="form_eliminar_extra" method="post" action="<?=base_url()?>index.php/profesor/procesa_eliminar_extra_autonomo" >
        <input class="form-control" name="id_extra_autonomo" id="id_extra_autonomo"   type="hidden" />
...
<!-- _________________ MODAL  AGREGAR  DEUDA PROFESOR _________________ -->

<div class="modal fade" id="agregar_deuda" tabindex="-1" role="dialog" aria-labelledby="agregar_deuda">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        
        <div class="modal-header" style=" background-color: #428BCA; color:#fff;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="exampleModalLabel">Agregar deuda a favor de UCEMA</h4>
        </div>
            
            <form method="post" name="form_cargar_deuda" id="form_cargar_deuda" action="<?=base_url()?>index.php/profesor/agregar_deuda_profesor" >
                ...
                <div class="modal-body">              
                    ...
                    <div class="form-group">
                        ...
                        <label for="profesor" class="control-label">Nombre</label>
                        <input class="form-control" name="profesor" id="profesor" type="text" readonly="readonly" /> 
                        
                        <label for="anio" class="control-label">Año</label>
                        <input class="form-control" name="anio" id="anio" type="text" value="<?=date('Y');?>" readonly="readonly" /> 
                        
                        <label for="importe" class="control-label">Importe</label>
                        <input class="form-control" name="importe" id="importe" type="text" /><br>
                        
                        <label>Comentarios</label>
                        <textarea class="form-control" id="comentarios" name="comentarios"  rows="3"></textarea>

                        <input class="form-control" name="id_profesor" id="id_profesor" type="hidden"/>
...
<!-- _________________ MODAL  EDITAR  DEUDA PROFESOR _________________ -->

<div class="modal fade" id="editar_deuda" tabindex="-1" role="dialog" aria-labelledby="editar_deuda">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        
        <div class="modal-header" style=" background-color: #428BCA; color:#fff;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="exampleModalLabel">Editar deuda a favor de UCEMA</h4>
        </div>
            
            <form method="post" name="form_edigar_deuda" id="form_edigar_deuda" action="<?=base_url()?>index.php/profesor/editar_deuda_profesor" >
