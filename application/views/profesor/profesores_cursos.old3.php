                                ...
                                <?php   if( $deudas_profesores->num_rows() > 0 ) : ?>
                                    ...
                                    <?php   foreach ($deudas_profesores->result() as $row): ?>
                                        ...
                                        <tr style="color:red">
                                            ...
                                            <td ><strong>&#8226; Deuda del profesor: </strong>  $<?=utf8_encode($row->IMPORTE_ADEUDADO)?>.  </td>
                                            <td colspan="2">

                                                <?php 
                                                    $datos_profesor_adedudador['importe'] = $row->IMPORTE_ADEUDADO;
                                                    $datos_profesor_adedudador['comentario'] = $row->COMENTARIO;
                                                ...
                                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" style=' margin-bottom:5px;  ' data-target="#deuda"> Elimina </button>
                                            ...
                                            <tr>
                                                 ...
                                                 <td>
                                                        <?php 
                                                            ...
                                                            $datos_extras_cargados['observaciones'] = rawurldecode($row->C_OBSERVACIONES);
