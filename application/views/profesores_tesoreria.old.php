...
<div id="page-wrapper" >
    ...
    <div id="page-inner" style="margin:0px; ">
        ...
        <form  name="profesores_form" id="profesores_form" method="POST" action="<?php base_url()?>/tesoreria/index.php/profesor/informacion_profesor/" ><!-- action="<?php base_url()?>/tesoreria/index.php/profesor_tesoreria/buscar_profesor_cursos/" -->
