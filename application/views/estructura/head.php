        ...
        <nav class="navbar-default navbar-side" role="navigation"  >
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?=base_url()?>index.php/home/"><i class="fa fa-home fa-2x" style="width:50px" ></i> Home </a>
                    </li> 
                    ...
                    <?php   if( in_array('ROLE_TESORERIA',$this->session->userdata('roles')) || in_array('ROLE_COORDINADOR',$this->session->userdata('roles')) ): ?>
                            ...
                            <li>
                               <a href="<?=base_url()?>index.php/profesor/"><i class="fa fa-users fa-2x"style="width:50px" ></i> Profesores</a>
                            </li>
                    ...
                    <?php   if( in_array('ROLE_TESORERIA',$this->session->userdata('roles')) ): ?>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bars fa-2x" style="width:50px" ></i> Programas </a>
                    ...
                    <?php   else:   ?>
                            ...
                            <li>
                                <a  href="#"><i class="fa fa-file fa-2x" style="width:50px"></i> Programas<span class="fa arrow"></span></a>
                                  <ul class="nav nav-second-level">
                    ...
                    <?php   if( in_array('ROLE_TESORERIA',$this->session->userdata('roles')) ): ?>
                        ...
                        <!-- CURSOS MODIFICADOS --> 
                        <li>
                           <a href="<?=base_url()?>index.php/programa/cursos_modificados"><i class="fa fa-refresh fa-2x" style="width:50px" ></i> Cursos Modificados <?php  if($notificacion_cursos_cambiados > 0): ?> <span style="background-color:red" class="badge "><?=$notificacion_cursos_cambiados?></span> <?php  endif; ?>  </a>
                        </li>

                        <!-- CURSOS SIN CONFIRMAR -->
                        <li>
                           <a href="<?=base_url()?>index.php/programa/cursos_sin_confirmar_coordinador"><i class="fa fa-check-square fa-2x" style="width:50px" ></i> Cursos sin confirmar </a>
                        </li>

                        <!-- CURSOS SIN LIQUIDACION -->
                        <li>
                           <a href="<?=base_url()?>index.php/programa/cursos_sin_importe_tesoreria"><i class="fa fa-usd fa-2x" style="width:50px" ></i> Cursos sin liquidacion </a>
                        </li>

                        <!-- Extras -->
                        <li>
                           <a href="<?=base_url()?>index.php/profesor/extras"><i class="fa fa-usd fa-2x" style="width:50px" ></i> Extras </a>
                        </li>

                        <!-- CURSOS EXTERNOS -->
                        <li>
                           <a href="<?=base_url()?>index.php/curso_externo/index"><i class="fa fa-external-link fa-2x" style="width:50px" ></i> Cursos externos </a>
                        </li>

                        <!-- RIACCO -->
                        <li>
                           <a href="<?=base_url()?>index.php/programa/riaco"><i class="fa fa-archive fa-2x" style="width:50px"></i> Riacco </a>
                        </li>

                        <!-- Res Prg -->
                        <li>
                           <a href="<?=base_url()?>index.php/programa/resumen_coordinadores_secretarios"> <i class="fa fa-tasks fa-2x" style="width:50px"></i> Coord y Sec. </a>
                        </li>
                    ...
                    <li>
                        <a href="<?=base_url()?>index.php/ayuda" > <i class="fa fa-question fa-2x" style="width:50px"></i>Ayuda </a>
                    </li>

                    <!-- SALIR -->
                    <li>
                        <a href="<?=base_url()?>index.php/login/logout" > <i class="fa fa-power-off fa-2x" style="width:50px" ></i>SALIR </a>
                    </li>     
