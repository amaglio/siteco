                    ...
                    <table class="table table-striped" style="border:none; margin-bottom:0px">
                        ...
                        <tr>
                            ...
                            <?php  /*if(in_array('ROLE_TESORERIA',$this->session->userdata('roles'))): ?>
                                <td><strong>&#8226; Puntos por contrato:</strong>  <?=utf8_encode($contrato_profesor->N_PUNTOS)?>.  </td>
                            <?php  endif; */ ?>

                            <?php /* if( in_array('ROLE_TESORERIA',$this->session->userdata('roles')) && isset($contrato_profesor->N_CLASE_EJEC) ): ?>
                                    
                                <td> <strong>&#8226; Prg Ejec:</strong>  <?=utf8_encode($contrato_profesor->N_CLASE_EJEC)?>.</td>
                            <?php  else: ?>
                                <td> </td>
                            <?php  endif; */?>
                        </tr>     
                                                ...
                                                <?php  if(in_array('ROLE_TESORERIA',$this->session->userdata('roles'))): ?>
                                                        ...
                                                        <td class="info" style="text-align:center;">   
                                                            ...
                                                            <?php  if( strtotime(date('d-M-y')) < strtotime($row->FECHA_INI) ):   
                                                                    ...
                                                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" style='width:70px; margin-bottom:5px; float:left;' data-target="#importeTesoreriaModal" data-whatever="<?=$datos_enviar_tesoreria?>"> Editar 2</button>
                                                            <?php  endif;   ?>
                                            ...
                                            <tr>
                                                 ...
                                                 <td>
                                                        <?php 
                                                            ...
                                                            $datos_extras_cargados['observaciones'] = rawurlencode($row->C_OBSERVACIONES);
