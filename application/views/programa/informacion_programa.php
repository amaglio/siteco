                             ...
                             <table class="table table-striped"> 
                                ...
                                <?php   foreach ($cursos_cambiados->result() as $row): ?>
                                    <tr>
                                        ...
                                        <td> <?=utf8_encode($row->USUARIO_ALTA)?> </td>
                                    </tr>    
                                <?php   endforeach; ?>
                        ...
                        <div class="panel-body">
                            ...
                            <?php   
                                ...
                                <?php   endif;
                                    ...
                                    if($datos_curso=$this->Programas_model->materia_curso_asignado($row->ID, $anio_programa, $row_programa->C_IDENTIFICACION, $row_programa->C_PROGRAMA, $row_programa->C_ORIENTACION )):
                                ...
                                <?php if($datos_curso): ?>
                                    ...
                                    <?
                                        ...
                                        foreach ($datos_curso->result() as $row_curso)
                                        { ?>
                                            
                                            <tr style="background-color: #80808078;
    font-size: 10px;
    color: black;" >
                                                <td> </td>
                                                <td colspan="3"><?=utf8_encode($row_curso->D_DESCRIP)?></td>
                                            </tr>
