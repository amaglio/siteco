    ...
    <div id="page-wrapper" > 
         <div class="row"  style="border-bottom:1px solid #000; color:#fff; border-top:1px solid #000; margin:0px; margin-bottom:10px; background-color:#202020;">
                ...
                <div class="col-md-11" style="text-align:left;">
                     <h4> <strong> <p style=" line-height:20px">   <?=utf8_encode($row_carrera->D_DESCRIP)?> <?="(".utf8_encode($row_carrera->D_DESCRED).")";?> </strong>  </p>
                </div>
         </div>  
         ...
         <div id="page-inner" style="margin:0px; padding:0px;">            
            ...
            <div class="row" >
             ...
             <div class="col-md-12"  style="margin:0px; padding:0px;">
               ...
               <div class="panel panel-default" style=" background-color:#F2F2F2; border:none">
