...
<div id="page-wrapper" >
     ...
     <div class="row"  style="border-bottom:1px solid #000; color:#fff; border-top:1px solid #000; margin:0px; margin-bottom:10px; background-color:#202020;">
            <div class="col-md-12 col-lg-12 ">
                <h4>  <i class="fa fa-users"></i> - <strong> Archivo Riaco </strong></h4>   
            </div>
    </div>  
    <div id="page-inner" style="margin:0px; ">
   
        <form  name="profesores_form" id="profesores_form" method="POST"  enctype="multipart/form-data" enctype="multipart/form-data" action="<?php base_url()?>/tesoreria/index.php/programa/procesa_archivo_riaco/" > <!-- action="<?php base_url()?>/tesoreria/index.php/profesor_tesoreria/buscar_profesor_cursos/" -->
        ...
        <div class="alert alert-success">
                Descargue el Archivo: <a href="/tesoreria/assets/uploads/riaco.dat" target="_blank">Riaco.dat</a>
        </div>
        ...
        <div class="alert alert-danger">
                ...
                <form method="post" action="<?php base_url()?>/tesoreria/index.php/programa/borrar_archivo_riaco/"  />
